...
func _enter_tree():
	if !ProjectSettings.has_setting("autoload/AudioRuntimeManager"):
		add_autoload_singleton("AudioRuntimeManager", "res://addons/FMOD/runtime/runtime_manager.gd")
...
func _exit_tree():
	...
	remove_autoload_singleton("AudioRuntimeManager")
