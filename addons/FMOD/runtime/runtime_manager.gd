...
func path_to_guid(path: String) -> String:
	return AudioRuntimeManager.studio_system.lookup_id(path)


func get_event_description(event_asset: EventAsset) -> EventDescription:
	var description: EventDescription
	description = AudioRuntimeManager.studio_system.get_event_by_id(event_asset.guid)
	return description
...
func get_event_description_id(guid: String) -> EventDescription:
	var description: EventDescription
	description = AudioRuntimeManager.studio_system.get_event_by_id(guid)
	return description
...
func attach_instance_to_node(instance: EventInstance, node, physicsbody = null) -> void:
	var runtime_manager = AudioRuntimeManager
